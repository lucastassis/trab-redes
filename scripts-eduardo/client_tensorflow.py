...
def main() -> None:
    ...
    plt.title('Preditito vs. Buffer Level Real CNN-LSTM para o host ' + str(processed))
    plt.savefig('Imagens/Preditito vs. Buffer Level CNN-LSTM para o host ' + str(processed) +'.png')  
